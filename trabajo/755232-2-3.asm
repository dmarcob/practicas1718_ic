...
@10          CMP nulo, nulo           #Comparación para forzar salto
@11         BEQ WHILE                 #Salto a WHILE
@12 2HALT:  MOV letra,tty-out         #Imprime caracter " " por pantalla
@13         ADD constante, INST       #Añade constante a @9 para pasar a la posición i+1 del vector
@14         CMP nulo, nulo            #Comparación para forzar
@15         BEQ INST                  #Salta a INST
@16 1HALT:  ADD letra,tty-out         #Imprime caracter "." por pantall
@17 END:    CMP nulo,nulo             #comparacion para forzar salto
@18        BEQ END                   #Salta a END
.end 
